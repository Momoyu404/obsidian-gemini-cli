...
// Mock GemineseService
jest.mock('@/core/agent', () => ({
  GemineseService: jest.fn().mockImplementation(() => ({
...
const createMockGemineseService = (overrides?: {
...
describe('Tab - Service Initialization', () => {
  describe('initializeTabService', () => {
    ...
    it('should create GemineseService on first initialization', async () => {
      const options = createMockOptions();
      const tab = createTab(options);
