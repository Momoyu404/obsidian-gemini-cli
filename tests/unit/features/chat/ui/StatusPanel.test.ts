...
class MockElement {
  ...
  querySelectorAll(selector: string): MockElement[] {
    ...
    const match = (el: MockElement): boolean => {
      ...
      // Handle class selectors like .geminese-status-panel
...
describe('StatusPanel', () => {
  ...
  describe('mount', () => {
    it('should create panel element when mounted', () => {
      ...
      expect(containerEl.querySelector('.geminese-status-panel')).not.toBeNull();
    });
  ...
  describe('updateTodos', () => {
    ...
    it('should display correct task count', () => {
      ...
      const label = containerEl.querySelector('.geminese-status-panel-label');
    ...
    it('should show current task in collapsed header', () => {
      ...
      const current = containerEl.querySelector('.geminese-status-panel-current');
    ...
    it('should render all todo items in content area', () => {
      ...
      const items = containerEl.querySelectorAll('.geminese-todo-item');
    ...
    it('should apply correct status classes to items', () => {
      ...
      expect(containerEl.querySelector('.geminese-todo-pending')).not.toBeNull();
      expect(containerEl.querySelector('.geminese-todo-in_progress')).not.toBeNull();
      expect(containerEl.querySelector('.geminese-todo-completed')).not.toBeNull();
    });
  ...
  describe('toggle', () => {
    ...
    it('should show list icon in header', () => {
      const icon = containerEl.querySelector('.geminese-status-panel-icon');
    ...
    it('should hide current task when expanded', () => {
      ...
      expect(containerEl.querySelector('.geminese-status-panel-current')).not.toBeNull();

      header!.click();

      expect(containerEl.querySelector('.geminese-status-panel-current')).toBeNull();
    });
  ...
  describe('accessibility', () => {
    ...
    it('should hide status icons from screen readers', () => {
      ...
      const icon = containerEl.querySelector('.geminese-todo-status-icon');
  ...
  describe('removeSubagent', () => {
    ...
    it('should remove a subagent by id', () => {
      ...
      const runningText = containerEl.querySelector('.geminese-status-panel-running-text');
  ...
  describe('destroy', () => {
    it('should remove panel from DOM', () => {
      ...
      expect(containerEl.querySelector('.geminese-status-panel')).toBeNull();
    });
  ...
  describe('updateSubagent', () => {
    ...
    it('should show done row when status changes to completed', () => {
      ...
      const doneRow = containerEl.querySelector('.geminese-status-panel-done-row');
    ...
    it('should show running row for running status', () => {
      ...
      const runningRow = containerEl.querySelector('.geminese-status-panel-running-row');
  ...
  describe('subagent status display', () => {
    ...
    it('should show done rows for completed and running row for running', () => {
      ...
      const doneRows = containerEl.querySelectorAll('.geminese-status-panel-done-row');
    ...
    it('should update display when subagent status changes', () => {
      ...
      let runningText = containerEl.querySelector('.geminese-status-panel-running-text');
      expect(runningText?.textContent).toBe('1 background task');
      ...
      runningText = containerEl.querySelector('.geminese-status-panel-running-text');
  ...
  describe('bash outputs', () => {
    ...
    it('should render bash section with header and entries', () => {
      ...
      const label = header!.querySelector('.geminese-tool-label');
      expect(label).not.toBeNull();
      expect(label!.textContent).toBe('Command panel');

      const entries = containerEl.querySelectorAll('.geminese-status-panel-bash-entry');
    ...
    it('should collapse and expand individual bash output entries', () => {
      ...
      const entry = containerEl.querySelector('.geminese-status-panel-bash-entry');
      expect(entry).not.toBeNull();

      const entryHeader = entry!.querySelector('.geminese-tool-header');
      ...
      const entryAfterClick = containerEl.querySelector('.geminese-status-panel-bash-entry');
      ...
      const entryAfterKeydown = containerEl.querySelector('.geminese-status-panel-bash-entry');
      const contentAfterKeydown = entryAfterKeydown!.querySelector('.geminese-tool-content');
    ...
    it('should update a running bash output to completed with output', () => {
      ...
      let entry = containerEl.querySelector('.geminese-status-panel-bash-entry');
      let text = entry!.querySelector('.geminese-tool-result-text');
      expect(text!.textContent).toBe('Running...');

      panel.updateBashOutput('bash-1', { status: 'completed', output: 'hello', exitCode: 0 });

      entry = containerEl.querySelector('.geminese-status-panel-bash-entry');
      text = entry!.querySelector('.geminese-tool-result-text');
      expect(text!.textContent).toBe('hello');

      const statusEl = entry!.querySelector('.geminese-tool-status');
    ...
    it('should update a running bash output to error', () => {
      ...
      const entry = containerEl.querySelector('.geminese-status-panel-bash-entry');
      const text = entry!.querySelector('.geminese-tool-result-text');
    ...
    it('should set aria-expanded on the bash section header', () => {
      ...
      header!.click();
      const headerAfterCollapse = containerEl.querySelector('.geminese-status-panel-bash-header');
      expect(headerAfterCollapse!.getAttribute('aria-expanded')).toBe('false');

      headerAfterCollapse!.click();
      const headerAfterExpand = containerEl.querySelector('.geminese-status-panel-bash-header');
