...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'geminese-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'geminese-instruction-original');
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'geminese-instruction-btn');
  ...
  describe('showClarification', () => {
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'geminese-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'geminese-instruction-refined');
