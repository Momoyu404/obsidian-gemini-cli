...
|-------|---------|---------|
| **core** | Infrastructure (no feature deps) | See [`src/core/ARCHITECTURE.md`](src/core/ARCHITECTURE.md) |
| **features/chat** | Main sidebar interface | See [`src/features/chat/ARCHITECTURE.md`](src/features/chat/ARCHITECTURE.md) |
...
| **style** | Modular CSS | See [`src/style/ARCHITECTURE.md`](src/style/ARCHITECTURE.md) |
